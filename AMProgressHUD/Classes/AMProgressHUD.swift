...
open class AMProgressHUD: UIView {
...
open class GifHUDOptions {
    ...
    open var backgroundAlpha:CGFloat = 0
    ...
    open var cancable = false
    /// The gif `imageview` content mode, the defualt is `scaleAspectFit`.
    open var contentMode: UIViewContentMode = .scaleAspectFit
}
